...
public class ChaoJDialog extends javax.swing.JDialog {
    ...
    void init(){
        ...
        progressBar.setForeground( new Color(243,115,35));
    ...
    private void initComponents() {
        ...
        progressBar.setPreferredSize(new java.awt.Dimension(514, 25));
        progressBar.setStringPainted(true);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/logocuabeHung.png"))); // NOI18N
